# Example showing drawer link usage
# This is a test file demonstrating the new drawer feature
...
**General information on [smoothing](?drawer=desmooth) and [appraisal bias](?drawer=appraisal_bias)...**
