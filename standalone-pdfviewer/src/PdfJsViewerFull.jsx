...
export default function PdfJsViewerFull({
  file,
  scale = 1,
  pageNumber = 1,
  onDocumentLoad,
      ...
      try {
        ...
        if (viewerRef.current) {
          viewerRef.current.innerHTML =
            '<p class="pdfjs-error">Unable to render PDF with pdfView2.</p>';
        }
      }
    };
  ...
  return (
    <div className="pdfjs-viewer-full">
      <div ref={outerContainerRef} className="pdfjs-viewer-full__container">
